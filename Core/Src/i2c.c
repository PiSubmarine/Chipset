...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
  ...
  /* USER CODE END I2C2_MspInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    GPIO_InitStruct.Pin = CHIPSET_SCL_Pin|CHIPSET_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
  ...
  */
    ...
    PA7     ------> I2C3_SCL
    */
    GPIO_InitStruct.Pin = BATCHG_SDA_Pin|BATCHG_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(RPI_SCL_GPIO_Port, RPI_SCL_Pin);

    HAL_GPIO_DeInit(RPI_SDA_GPIO_Port, RPI_SDA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(CHIPSET_SCL_GPIO_Port, CHIPSET_SCL_Pin);

    HAL_GPIO_DeInit(CHIPSET_SDA_GPIO_Port, CHIPSET_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA7     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(BATCHG_SDA_GPIO_Port, BATCHG_SDA_Pin);

    HAL_GPIO_DeInit(BATCHG_SCL_GPIO_Port, BATCHG_SCL_Pin);
